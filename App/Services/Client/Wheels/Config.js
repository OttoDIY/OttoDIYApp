  ...
  skills: [
    {
      ...
      items: [
        { title: 'Jitter', image: Images.wheels.rotateright, cmd: 'M 19', stopAtEnd: true },
        { title: 'Swing', image: Images.wheels.rotateleft, cmd: 'M 8', stopAtEnd: true },
        { title: 'Tiptoe', image: Images.wheels.wigle, cmd: 'M 14', stopAtEnd: true },
        { title: 'Ascend', image: Images.wheels.zigzag, cmd: 'M 20', stopAtEnd: true },
        { title: 'Up Down', image: Images.wheels.zigzag2, cmd: 'M 5', stopAtEnd: true },
        { title: 'Flap Back', image: Images.wheels.wabbleleft, cmd: 'M 13', stopAtEnd: true },
        { title: 'Moonwalk Left', image: Images.wheels.spinleft, cmd: 'M 7', stopAtEnd: true },
        { title: 'Shake Left', image: Images.wheels.shakeleft, cmd: 'M 17', stopAtEnd: true },
        { title: 'Bend Left', image: Images.wheels.jiggleleft, cmd: 'M 15', stopAtEnd: true },
        { title: 'Cross Left', image: Images.wheels.crossleft, cmd: 'M 10', stopAtEnd: true },
        { title: 'Flap Front', image: Images.wheels.wabbleright, cmd: 'M 12', stopAtEnd: true },
        { title: 'Moonwalk Right', image: Images.wheels.spinright, cmd: 'M 6', stopAtEnd: true },
        { title: 'Shake Right', image: Images.wheels.shakeright, cmd: 'M 18', stopAtEnd: true },
        { title: 'Bend Right', image: Images.wheels.jiggleright, cmd: 'M 16', stopAtEnd: true },
